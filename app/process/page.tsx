      ...
      >
        <div className="flex gap-2">
          {totalJobsCount > 0 && !running ? (
            <button id="tour-start-process" onClick={startProcessing} className="text-sm bg-primary hover:bg-primary-hover text-white px-4 py-2 rounded font-semibold flex items-center gap-2 transition-colors">
