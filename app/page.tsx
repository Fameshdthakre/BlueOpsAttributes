    ...
    <div className="min-h-screen bg-bg-dark text-text-main flex flex-col items-center overflow-x-hidden">
      ...
      <section className="w-full border-y border-bg-input bg-bg-card/50 py-10 mt-20 relative z-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-80">
            ...
            <div className="flex items-center gap-3 text-xl font-bold text-text-main">
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7">
                <path d="M17.653 11.594l-3.415-5.914a.276.276 0 0 0-.24-.138H13.84a.276.276 0 0 0-.24.138L4.694 21.096a.277.277 0 0 0 .24.414h1.705a.275.275 0 0 0 .239-.138l7.214-12.502 3.327 5.76a.275.275 0 0 1 0 .277l-2.072 3.59a.276.276 0 0 1-.24.138h-2.148l2.977-5.158-1.503-2.602-5.748 9.96A1.854 1.854 0 0 0 10.3 23.498h3.332a1.857 1.857 0 0 0 1.611-.928l3.968-6.87a.276.276 0 0 0 0-.276" />
                <path d="M13.255 13.916l1.353 2.343-1.636 2.836h-2.705z" />
              </svg>
              Anthropic
            </div>
            {/* Google Gemini */}
      ...
      <section className="w-full max-w-6xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-text-muted text-lg max-w-2xl mx-auto">
            BlueOps doesn't just guess attributes. It strictly adheres to your
            defined taxonomies to ensure zero hallucinations.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-bg-card border border-bg-input rounded-2xl p-8 hover:border-primary/50 transition-colors group">
            ...
            <p className="text-text-muted leading-relaxed">
              Total data privacy and zero markup. Plug in your own API keys for
              OpenAI, Anthropic, or Gemini and pay for direct usage only.
            </p>
          </div>
          ...
          <div className="bg-bg-card border border-bg-input rounded-2xl p-8 hover:border-accent/50 transition-colors group">
            ...
            <p className="text-text-muted leading-relaxed">
              Provide a Taxonomy sheet with allowed dropdown values. Our engine
              forces the AI to map extracted features strictly to your allowed
              options.
            </p>
          </div>
          ...
          <div className="bg-bg-card border border-bg-input rounded-2xl p-8 hover:border-blue-400/50 transition-colors group">
            ...
            <p className="text-text-muted leading-relaxed">
              Don't wait hours for sequential processing. BlueOps fans out your
              requests concurrently, churning through thousands of ASINs in
              minutes.
            </p>
          </div>
          ...
          <div className="bg-bg-card border border-bg-input rounded-2xl p-8 hover:border-purple-400/50 transition-colors group">
            ...
            <h3 className="text-xl font-bold mb-3">
              Intelligent Excel Exports
            </h3>
            <p className="text-text-muted leading-relaxed">
              Instantly download color-coded match status reports. See exactly
              what was Validated, Free Text, Unresolved, or Failed.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-bg-card border-y border-bg-input py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-text-muted text-lg max-w-2xl mx-auto">
              Three simple steps to transform raw ASINs into structured catalog
              data.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 relative">
            ...
            <div className="flex-1 relative z-10 bg-bg-dark border border-bg-input p-6 rounded-2xl shadow-lg hover:-translate-y-2 transition-transform duration-300">
              <div className="w-10 h-10 rounded-full bg-primary text-white font-bold flex items-center justify-center mb-4 absolute -top-5 left-6 shadow-lg shadow-primary/30">
                1
              </div>
              <h3 className="text-xl font-bold mt-2 mb-2">Upload ASINs</h3>
              <p className="text-sm text-text-muted leading-relaxed">
                Upload your ASIN list and map your columns. BlueOps
                automatically handles missing data formats.
              </p>
            </div>

            {/* Step 2 */}
            <div className="flex-1 relative z-10 bg-bg-dark border border-bg-input p-6 rounded-2xl shadow-lg hover:-translate-y-2 transition-transform duration-300">
              <div className="w-10 h-10 rounded-full bg-accent text-white font-bold flex items-center justify-center mb-4 absolute -top-5 left-6 shadow-lg shadow-accent/30">
                2
              </div>
              <h3 className="text-xl font-bold mt-2 mb-2">Provide Taxonomy</h3>
              <p className="text-sm text-text-muted leading-relaxed">
                Upload your validation sheet to force the AI to select only from
                your approved dropdowns.
              </p>
            </div>

            {/* Step 3 */}
            <div className="flex-1 relative z-10 bg-bg-dark border border-bg-input p-6 rounded-2xl shadow-lg hover:-translate-y-2 transition-transform duration-300">
              <div className="w-10 h-10 rounded-full bg-purple-500 text-white font-bold flex items-center justify-center mb-4 absolute -top-5 left-6 shadow-lg shadow-purple-500/30">
                3
              </div>
              <h3 className="text-xl font-bold mt-2 mb-2">Extract & Export</h3>
              <p className="text-sm text-text-muted leading-relaxed">
                Hit start and watch the AI churn through the queue. Export your
                results instantly to Excel.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-text-muted mb-10 text-lg">
          Join BlueOps today and bring unparalleled accuracy to your e-commerce
          catalog.
        </p>
        <Link
          href="/signup"
