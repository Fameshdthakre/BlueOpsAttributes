  ...
  return (
    <>
      ...
      >
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className={`font-medium text-white whitespace-nowrap transition-opacity duration-300 ${isExpanded ? "opacity-100" : "opacity-0"}`}
                >
                  {item.name}
                </span>
              </Link>
        ...
        {/* Footer */}
        <div
          className={`p-4 border-t border-bg-input flex flex-col items-center justify-center gap-1 transition-opacity duration-300 ${isExpanded ? "opacity-100" : "opacity-0 h-0 overflow-hidden py-0 border-transparent"}`}
        >
